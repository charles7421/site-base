	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Empresa->save($this->request->data)) {
				$this->Session->setFlash(__('Perfil da empresa salvo com sucesso.'));
 ...
 */
	public function edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->Empresa->save($this->request->data)) {
				$this->Session->setFlash(__('Perfil da empresa editada com sucesso.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The empresa could not be saved. Please, try again.'));
			}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Empresa->delete()) {
			$this->Session->setFlash(__('Perfil da empresa excluida com sucesso.'));
		} else {
